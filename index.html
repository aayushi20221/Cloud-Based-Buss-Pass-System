        ...
        <div class="container">
          <div class="row align-items-center justify-content-center text-center">
            ...
            <div class="col-md-12" data-aos="fade-up" data-aos-delay="400">
              <h1 class="text-white font-weight-light">Cloud Based Bus Pass System</h1>
              <p class="mb-5">A project developed by our team!!</p>
              <p><a href="book.php" class="btn btn-primary py-3 px-5 text-white">Book Now!</a></p>
            </div>
          </div>
        </div>
      </div>  
        ...
        <div class="row">
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
            <a href="#" class="unit-1 text-center">
              <img src="images/img_2.jpg" alt="Image" class="img-fluid" style="height: 353px">
              <div class="unit-1-text">
                <h3 class="unit-1-heading">Saksham Johri</h3>
              </div>
            </a>
          </div>
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
            <a href="#" class="unit-1 text-center">
              <img src="images/img_1.jpg" alt="Image" class="img-fluid" style="height: 353px">
              <div class="unit-1-text">
                <h3 class="unit-1-heading">Pranjul Singhal</h3>
              </div>
            </a>
          </div>
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
            <a href="#" class="unit-1 text-center">
              <img src="images/img_3.jpg" alt="Image" class="img-fluid" style="height: 353px">
              <div class="unit-1-text">
                <h3 class="unit-1-heading">Aayushi Rai</h3>
              </div>
            </a>
          </div>
        </div>
